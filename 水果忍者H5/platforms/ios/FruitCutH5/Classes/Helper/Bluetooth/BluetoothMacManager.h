...
typedef enum{
    CommandSmellClose = 0x00,
    CommandSmellBanana = 0x01,
    CommandSmellApple = 0x02,
    CommandSmellKiwifruit = 0x03,
    CommandSmellOrange = 0x04,
    CommandSmellWatermelon = 0x05,
    CommandSmellPear = 0x06,
    CommandSmellPineapple = 0x07,
    CommandSwitchStatus = 0x20
} BluetoothCommand;
